...
def preBuildCertificates(env):
    ...
    f.write("// This file is generated by a computer at every build (`build/preBuildCertificates.py` in PlatformIO)\n\n")
    ...
    f.write("constexpr static const uint8_t* const indexes[] PROGMEM = {")
    for i in range(0, idx):
        f.write("idx_" + str(i))
        if i<idx-1:
            f.write(", ")
